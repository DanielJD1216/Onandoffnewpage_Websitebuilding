...
import { Plane, Phone, ArrowRight, Home, CheckCircle, Clock } from 'lucide-react';
...
export default function ArrivalPage({ params }: { params: { locale: string } }) {
  ...
  const tabs = [
    { id: 'overview', label: '정착 타임라인', icon: Clock },
    { id: 'airport', label: '공항 픽업', icon: Plane },
    { id: 'homestay', label: '홈스테이', icon: Home }
  ];
    ...
    <div className="min-h-screen bg-gradient-to-br from-brand-ivory via-white to-brand-ivory/50">
      ...
      <section className="py-16">
        <div className="container mx-auto px-4">
          ...
          {/* Overview Tab - Settlement Timeline */}
          {activeTab === 'overview' && (
          ...
          {activeTab === 'airport' && (
            <div className="max-w-4xl mx-auto">
              <div className="text-center mb-12">
                <h2 className="text-3xl font-black text-brand-green mb-4">공항 픽업 서비스</h2>
                <p className="text-xl text-brand-gold">입국부터 첫 숙소 도착까지, 전 과정을 안전하게 지원합니다</p>
              </div>

              {/* Pickup Process Cards */}
              ...
              {/* Airport Pickup Service Features */}
              <Card className="p-8 bg-gradient-to-br from-brand-green/5 to-brand-gold/5">
                <h3 className="text-2xl font-black text-brand-green mb-6 text-center">서비스 포함 사항</h3>
                <div className="grid md:grid-cols-2 gap-4">
                  <div className="flex items-start">
                    <div className="w-2 h-2 bg-brand-gold rounded-full mr-3 mt-2"></div>
                    <span className="text-gray-700">입국 심사 가이드</span>
                  </div>
                  <div className="flex items-start">
                    <div className="w-2 h-2 bg-brand-gold rounded-full mr-3 mt-2"></div>
                    <span className="text-gray-700">스터디 퍼밋 수령 지원</span>
                  </div>
                  <div className="flex items-start">
                    <div className="w-2 h-2 bg-brand-gold rounded-full mr-3 mt-2"></div>
                    <span className="text-gray-700">세관 통과 도움</span>
                  </div>
                  <div className="flex items-start">
                    <div className="w-2 h-2 bg-brand-gold rounded-full mr-3 mt-2"></div>
                    <span className="text-gray-700">홈스테이까지 안전 이동</span>
                  </div>
                </div>
              </Card>
            </div>
          ...
          {activeTab === 'homestay' && (
            <div className="max-w-4xl mx-auto">
              ...
              {/* Homestay Features */}
              <Card className="p-8 bg-gradient-to-br from-white to-brand-ivory/50 mb-8">
                <h3 className="text-2xl font-black text-brand-green mb-6 text-center">홈스테이 선택 기준</h3>
                <div className="grid md:grid-cols-3 gap-6">
                  <div className="text-center">
                    ...
                    <h4 className="font-bold text-brand-green mb-2">안전한 환경</h4>
                    <p className="text-sm text-gray-600">범죄율이 낮은 안전한 지역의 검증된 가정</p>
                  </div>
                  <div className="text-center">
                    <div className="bg-brand-green/10 p-4 rounded-full w-16 h-16 mx-auto mb-3 flex items-center justify-center">
                      <span className="text-2xl">🚌</span>
                    </div>
                    <h4 className="font-bold text-brand-green mb-2">학교 접근성</h4>
                    <p className="text-sm text-gray-600">학교까지 30분 이내 대중교통 접근</p>
                  </div>
                  <div className="text-center">
                    <div className="bg-brand-green/10 p-4 rounded-full w-16 h-16 mx-auto mb-3 flex items-center justify-center">
                      <span className="text-2xl">🍽️</span>
                    </div>
                    <h4 className="font-bold text-brand-green mb-2">한식 제공</h4>
                    <p className="text-sm text-gray-600">한국 학생을 위한 맞춤 식사 제공</p>
                  </div>
                </div>
              </Card>

              {/* Homestay Matching Process */}
              <Card className="p-8 bg-white border-2 border-brand-green/20">
                <h3 className="text-2xl font-black text-brand-green mb-6 text-center">홈스테이 매칭 프로세스</h3>
                <div className="space-y-4">
                  <div className="flex items-start">
                    <div className="bg-brand-green text-white rounded-full w-6 h-6 flex items-center justify-center font-bold mr-3 mt-1 flex-shrink-0">
                      1
                    </div>
                    <div>
                      <h4 className="font-bold text-brand-green mb-1">학생 정보 분석</h4>
                      <p className="text-sm text-gray-600">성격, 취향, 알러지, 특별 요구사항 파악</p>
                    </div>
                  </div>
                  <div className="flex items-start">
                    <div className="bg-brand-green text-white rounded-full w-6 h-6 flex items-center justify-center font-bold mr-3 mt-1 flex-shrink-0">
                    ...
                    <div>
                      <h4 className="font-bold text-brand-green mb-1">홈스테이 매칭</h4>
                      <p className="text-sm text-gray-600">3-5개 후보 가정 선정 및 상세 정보 제공</p>
                    </div>
                  </div>
                  <div className="flex items-start">
                    <div className="bg-brand-green text-white rounded-full w-6 h-6 flex items-center justify-center font-bold mr-3 mt-1 flex-shrink-0">
                    ...
                    <div>
                      <h4 className="font-bold text-brand-green mb-1">사전 미팅</h4>
                      <p className="text-sm text-gray-600">화상 미팅을 통한 상호 인사 및 확인</p>
                    </div>
                  </div>
                  <div className="flex items-start">
                    <div className="bg-brand-green text-white rounded-full w-6 h-6 flex items-center justify-center font-bold mr-3 mt-1 flex-shrink-0">
                    ...
                    <div>
                      <h4 className="font-bold text-brand-green mb-1">최종 확정</h4>
                      <p className="text-sm text-gray-600">계약서 작성 및 입주 일정 조율</p>
                    </div>
                  </div>
                </div>
              </Card>
